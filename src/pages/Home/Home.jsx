...
const Home = () => {
    return (
        <div>
            ...
            <FoodCardHome />
            <Baner02 />
            <SectionTitle heading={'Check out @foodieland on Instagram'} subHeading={'Lorem, ipsum dolor sit amet consectetur adipisicing elit. Officia libero nihil eius perferendis eos temporibus deserunt harum, a fugit molestiae.'} />
            <SecondCards />
            <Banner />
        </div>
    );
